...
export default function ShowUserTrailerReport({ report, users }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Trailer Reports', href: routes.index().url },
        {
    ...
    const handleSendEmail = () => {
        ...
        router.post(
            `/user/trailer-reports/${report.date}/email`,
                    ...
                    <div className="flex gap-2">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                <DropdownMenuItem
                                    onClick={() => {
                                        window.location.href = `/user/trailer-reports/${report.date}/pdf`;
                                    }}
                                >
                                    <Download className="mr-2 h-4 w-4" />
                                    Download PDF
                                ...
                                <DropdownMenuItem
                                    onClick={() => {
                                        window.location.href = `/user/trailer-reports/${report.date}/excel`;
                                    }}
                                >
