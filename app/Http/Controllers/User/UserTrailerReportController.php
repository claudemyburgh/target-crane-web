...
class UserTrailerReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('user/trailer-loaded-reports/index', [
            'reports' => $reports,
            'filters' => [
    ...
    public function show(Request $request, TrailerLoadedReport $trailerLoadedReport)
    {
        ...
        return Inertia::render('user/trailer-loaded-reports/show', [
            'report' => [
